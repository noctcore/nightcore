...
export function useBoardActions({
  ...
  const detailActions = useMemo<TaskDetailActions>(
    () => ({
      ...
      onChangeTitle: lifecycle.handleChangeTitle,
      onChangeDescription: lifecycle.handleChangeDescription,
    ...
    [
      ...
      lifecycle.handleChangeTitle,
      lifecycle.handleChangeDescription,
