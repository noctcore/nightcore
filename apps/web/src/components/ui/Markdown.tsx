...
/** Cosmic-dark markdown renderer (M4.7 §D): a sanitizing, lightweight primitive
 *  for assistant turns, the reviewer verdict, and plan text. `marked` parses to
 *  HTML, `DOMPurify` strips anything unsafe (scripts, event handlers, raw HTML
 *  injection). Prose styling is scoped to `.nc-markdown` in styles.css so code
 *  blocks, lists, headings, and inline code match the app surface. */
